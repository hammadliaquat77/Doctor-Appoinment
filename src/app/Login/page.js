...
export default async function LoginPage() {
  ...
  <div className="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
    <div className="max-w-md mx-auto">
      ...
      <div className="mt-5">
        <div
          className="py-2 px-4 w-full bg-blue-600 hover:bg-blue-700 focus:ring-blue-500 focus:ring-offset-blue-200 text-white transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
          // type="submit"
        >
          Log in
        </div>
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <h1 className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">
          or sign up
        </h1>
        </Link>
